...
image: /images/places/uct-cmc-destination-feat-uct-university-cape-town.jpg
...
Each person we have at the event costs the Indaba𝕏 ~R1700. Considering we have 300 people, this is a lot of money. We are very grateful to our [partners](/partners) for making this possible.
...
#### {{<icon "fa-solid fa-mug-saucer">}} &nbsp; **Will there be coffee?** {.faq-item}
...
#### {{<icon "ti-alert">}} &nbsp; **Is Cape Town safe?** {.faq-item}
