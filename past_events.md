...
layout: default
title: Past events
hero_image: /assets/images/past.jpg
---

A look back at previous editions of the Deep Learning IndabaX South Africa. 
...
<div class="event-list">
  ...
  <li>9 workshops</li>
  <li>4 fundamentals</li>
  <li>30+ posters</li> 
  <li>2 hackathon challenges</li> 
  <li>AI Fest</li>
  </ul>

  <strong>Keynote speakers:</strong>
  <ul>
    <li>Dr Ndivhuwo Makondo (IBM)</li>
    <li>Prof Okuthe P. Kogeda (UKZN)</li>
    <li>Dr Herkulaas Combrink (University of the Free State)</li>
    <li>Prof Chijioke Okorie (University of Pretoria)</li>
  </ul>
</div>
...
<strong>Keynote speakers:</strong> 
<ul>
<li>Stuart Reid (Nosible)</li>
<li>Prof Pius Owolawi Reid (Tshwane University of Technology)</li>
<li>Prof Marlene Holmner (University of Pretoria)</li>
<li>Dr Axel Tidemann (Takealot)</li>
<li>Prof Francesco Petruccione (Stellenbosch University and NITheCS) </li>
</ul>
</div>
...
<strong>Keynote speakers:</strong> 
<ul>
<li>Pelenomi Moiloa (Lelapa AI)</li>
<li>Dr Jabu Mtsweni (CSIR)</li>
<li>Dr Emmanuel Dufourq (AIMS)</li>
<li>Prof Mpho Raborife (Institute for Intelligent Systems, Primus Tech Hub)</li>
<li>Henrica Makulu Kadira (Medscheme Holdings) </li>
</ul>
</div>
...
<div class="event" markdown="1">
### 2023 - University of Cape Town, 12-14 July 2024
...
<strong>Keynote speakers:</strong> 
<ul>
<li>Dr Paul Amayo (University of Cape Town)</li>
<li>Prof Kshitij Thorat (University of Pretoria)</li>
<li>Prof Jan van Zyl (Ecosystem AI)</li>
<li>Prof Emma Ruttkamp-Bloem (University of Pretoria)</li>
<li>John Kamara (Adanian Labs & AAICE) </li>
</ul>
</div>
...
<strong>Keynote speakers:</strong> 
<ul>
<li>Dr Vukosi Marivate (University of Pretoria)</li>
<li>Jade Abbott (Masakhane, Retro Rabbit)</li>
<li>Frans Cronje (DataProphet)</li>
<li>Prof Marelie Hattingh Davel (North-West University)</li>
</ul>
</div>
...
<div class="event" markdown="1">
### 2021 - Online roadshow, 3 September - 26 November 2021
...
<strong>Keynote speakers:</strong> 
<ul>
<li>Prof Tshilidzi Marwala (University of Johannesburg)</li>
<li>Dr Andrew Saxe (University of Oxford)</li>
<li>Prof Bruce Bassett (University of Cape Town)</li>
</ul>
</div>
...
<div class="event" markdown="1">
### 2018 - University of Cape Town, 6 April 2018
